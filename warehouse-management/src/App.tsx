...
import { Users, Warehouse, Route as RouteIcon, UserPlus, Pencil, Trash, Plus, LogOut, Bot } from "lucide-react";
...
import { RobotManagementPage } from './pages/robot-management/RobotManagementPage';
    ...
    <div className="min-h-screen bg-zinc-50 p-8">
      <header className="mb-8">
        ...
        <div className="mt-4 flex gap-4">
          ...
          <Button
            variant={location.pathname === '/robots' ? 'default' : 'outline'}
